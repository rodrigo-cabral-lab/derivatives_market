...
st.sidebar.title("DERIVATIVOS")
st.sidebar.subheader('Gestão de Risco de Mercado')
cria_prot = st.sidebar.checkbox("Gestão de Risco para Proteção")

cria_port = st.sidebar.checkbox("Cria portifólio de Commodities")
...
if cria_prot:
   st.write('vamos entrar com o codigo') 	
